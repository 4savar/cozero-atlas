    ...
    <div className="bg-surface/60 py-8 sm:py-10 lg:py-14">
      <div className="mx-auto max-w-6xl px-6 lg:px-8">
        ...
        <div className="mb-6 rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm leading-relaxed text-amber-950">
          ...
          Environmental metrics are synthetic values for product evaluation and do not represent live measurements. Expanded population and geographic records use U.S. Census Vintage 2025 and 2025 Gazetteer datasets (verified July 23, 2026).
        </div>
        <DashboardView />
      </div>
    </div>
